# SpO2–Spindle–Dementia Stratification: BY EDUCATION 
...
# Define covariate groups. Education is not used as a covariate here.  
covariate_sets <- list(
  Unadjusted = c(),
  Group1 = c("age", "bmi", "sex"),
  Group2 = c("age", "bmi", "sex", "smoking", "alcohol"),
  Group3 = c("age", "bmi", "sex", "smoking", "alcohol", "group1_med", "group2_med")
)
