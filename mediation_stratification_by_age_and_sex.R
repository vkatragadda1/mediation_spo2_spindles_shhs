# SpO2–Spindle–Dementia Stratification: BY AGE and SEX 
...
# Define covariate groups. Neither age nor sex are used as covariates here. 
covariate_sets <- list(
  Unadjusted = c(),
  Group1 = c("bmi"),
  Group2 = c("bmi", "smoking", "alcohol", "education"),
  Group3 = c("bmi", "smoking", "alcohol", "education", "group1_med", "group2_med")
)
