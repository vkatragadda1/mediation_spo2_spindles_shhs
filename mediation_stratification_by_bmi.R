# SpO2–Spindle–Dementia Stratification: BY BMI 
...
# Define covariate groups. BMI is not used as a covariate here.  
covariate_sets <- list(
  Unadjusted = c(),
  Group1 = c("age", "sex"),
  Group2 = c("age", "sex", "smoking", "alcohol", "education"),
  Group3 = c("age", "sex", "smoking", "alcohol", "education", "group1_med", "group2_med")
)
